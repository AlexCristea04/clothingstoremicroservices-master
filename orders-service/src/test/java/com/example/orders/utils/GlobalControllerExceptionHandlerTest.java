...
import com.example.orders.utils.exceptions.InUseException;
...
import com.example.orders.utils.exceptions.OrderNotFoundException;
...
public class GlobalControllerExceptionHandlerTest {
    ...
    void handleOrderNotFoundException() {
        ...
        assertEquals(expectedStatus, handler.handleOrderNotFoundException(request, ex).getHttpStatus());
        assertNotNull(handler.handleOrderNotFoundException(request, ex).getMessage());
    }

    @Test
    void handleOrderNotFoundExceptionWithMessageAndCause() {
        String message = "Order not found";
        Throwable cause = new Throwable("Cause of order not found");
    ...
    @Test
    void handleOrderNotFoundExceptionWithCause() {
        Throwable cause = new Throwable("Cause of husband not found");
    ...
    @Test
    void handleOrderNotFoundExceptionNoMessage() {
        OrderNotFoundException ex = new OrderNotFoundException();
        WebRequest request = mock(WebRequest.class);
        HttpStatus expectedStatus = HttpStatus.NOT_FOUND;

        assertEquals(expectedStatus, handler.handleOrderNotFoundException(request, ex).getHttpStatus());
        assertNull(handler.handleOrderNotFoundException(request, ex).getMessage());
    }
}
