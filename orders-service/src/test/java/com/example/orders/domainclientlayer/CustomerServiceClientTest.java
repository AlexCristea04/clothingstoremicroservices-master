...
public class CustomerServiceClientTest {
    ...
    public void testGetCustomerByCustomerId() {
        ...
        when(restTemplate.getForObject(url, CustomerModel.class)).thenReturn(expectedModel);

        // Act
        CustomerModel result = customerServiceClient.getCustomerByCustomerId(customerId);

        // Assert
        assertNotNull(result);
        verify(restTemplate, times(1)).getForObject(url, CustomerModel.class);
    }
    ...
    public void testGetCustomerByCustomerId_NotFound() throws IOException {
        ...
        when(restTemplate.getForObject(url, CustomerModel.class)).thenThrow(ex);
